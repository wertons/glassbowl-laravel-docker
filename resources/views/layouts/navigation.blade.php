        ...
        <div class="sm:flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button id="logout-dropdown" class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            <div class="w-auto">{{ Auth::user()->name }}</div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 flex">
            ...
            <div class="w-full flex items-center justify-end mr-3">
                ...
                <form class="inline" method="POST" action="{{ route('logout') }}">
                    ...
                    <x-button class="bg-red-50 text-red-800">
